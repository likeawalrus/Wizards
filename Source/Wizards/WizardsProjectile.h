...
public:
	...
	void SpellCreation(FtheSpell* theSpell, UParticleSystem* projPart, UParticleSystem* blastPart, TSubclassOf<class AWizardsBlast> myBlastClass, AWizardsCharacter* theWiz);
