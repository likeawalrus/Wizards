...
AWizardsCage::AWizardsCage()
{
	...
	CollisionComp->InitBoxExtent(FVector(1.0, 1.0, 1.0));
	...
	theWall = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("MyCageMesh"));
	theWall->SetupAttachment(RootComponent);

}


bool AWizardsCage::DoTrace(FHitResult* RV_Hit, FCollisionQueryParams* RV_TraceParams)
{
...
void AWizardsCage::SpellCreation(FtheSpell* theSpell, UParticleSystem* floorPart, UStaticMesh* thisWall, AWizardsCharacter* theWiz)
{
